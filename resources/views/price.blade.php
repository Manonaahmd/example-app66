...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset('assets/images/blue_jay_bird_nature.jpg') }}" type="image/x-icon">
            ...
            <div class="carousel-item active">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-md-5 ">
                    <div class="img-box">
                      <img src="{{ asset('assets/images/blue_jay_bird_nature.jpg') }}"
                      alt="image bird">
                    </div>
                  </div>
                </div>
    ...
    <div class="box">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="img-box">
              <img src=<img src="{{ asset('assets/images/blue_jay_bird_nature.jpg') }}"
              alt="image bird">
